...
// --- PROYECTOS (CON SKELETON SCREENS) ---
...
async function cargarProyectos() {
    ...
    proyectos.forEach((p, index) => {
        ...
        article.style.animationDelay = `${(index * 0.2) + 0.1}s`;
        
        article.innerHTML = `
            <div class="project-image">
                <img src="${p.imagen_url || ''}" alt="${p.titulo}" onerror="this.style.display='none'; this.parentNode.style.backgroundColor='#1a1a1a';">
            </div>
...
async function cargarMensajes() {
    ...
    try {
        ...
        msgs.forEach(m => {
            const date = new Date(m.creado_en).toLocaleString();
            container.innerHTML += `
                <div class="message-card">
                    <div class="message-header">
                        <strong>${m.nombre || 'Usuario'} &lt;${m.email}&gt;</strong>
                        <span>${date}</span>
                    </div>
...
const translations = {
    es: {
        ...
        nav_dash: "ADMIN",
        hero_title: "Ing. Marcos Despujos",
        hero_desc: "PROYECTOS",
        btn_download: "DESCARGAR BOT BITACORA BETA",
        ...
        btn_send: "ENVIAR",
        footer_rights: "&copy; 2024 DESPUX. Todos los derechos reservados.",
    ...
    en: {
        ...
        nav_works: "WORKS",
        nav_dash: "ADMIN",
        hero_title: "Eng. Marcos Despujos",
        hero_desc: "PROJECTS",
        btn_download: "DOWNLOAD LOG BOT BETA",
        ...
        btn_send: "SEND",
        footer_rights: "&copy; 2024 DESPUX. All rights reserved.",
    ...
    de: {
        ...
        hero_title: "Ing. Marcos Despujos",
        hero_desc: "PROJEKTE",
        btn_download: "LOG BOT BETA HERUNTERLADEN",
        ...
        btn_send: "SENDEN",
        footer_rights: "&copy; 2024 DESPUX. Alle Rechte vorbehalten.",
